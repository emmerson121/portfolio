...
import './App.css';
import snap0 from './img/snap0.jpeg';
...
import youtube from './img/youtube2.jpeg';
...
function App() {
  ...
  return (
    ...
    <div className='wrap'>
      <div className='emm'>
      <img className='image' src={snap0} alt='images' />
      </div>
    </div>
    </div>
...
<div id='proj'>
<div className='pro'>
  <div className='main4'>Its supposed to be here</div>
...
<div className='blogs'>
  ...
  <div className='blog'>
    ...
    <div className='central'>
      ...
      <div className='react'>5 Command Lines Tips and Tricks All Web Developers Should Kmow</div>
      <p className='par'>When apps start to grow you can easily end up including too many components making it heavier and slow to laod. One of the solutions to the problem is Code-Splitting and Webpack is probably...</p>
      <button className='read'>Read more...</button>
      </div>
